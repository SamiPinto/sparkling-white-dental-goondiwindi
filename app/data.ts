...
export const FAQS = {
  ...
  items: [
    ...
    },
    {
      ...
      a: "Leave your details below and our Goondiwindi team will call you back the same day to confirm.",
    },
  ],
};
...
export const FORM = {
  ...
  sub: "Tell us a little about you and when you'd like to start — our Goondiwindi team will call to confirm.",
