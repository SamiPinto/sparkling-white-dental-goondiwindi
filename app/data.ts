// Central data for the Goondiwindi VENEERS landing page (content brief v2).
...
export const HERO = {
  eyebrow: "Porcelain Veneers · Goondiwindi",
  ...
  photo: "/images/gdi-hero-mirror.webp" as string | null,
  photoAlt:
  ...
  items: [
    {
      ...
      photo: "/images/gdi-qual-chipped.webp",
    ...
    },
    {
      ...
      photo: "/images/gdi-qual-stains.webp",
    ...
    },
    {
      ...
      photo: "/images/gdi-qual-gaps.webp",
...
export const GALLERY = {
  ...
  disclaimer:
    "Real patient results at Sparkling White Dental Goondiwindi. Individual results vary. Photos shown with patient consent.",
  items: [
    {
      label: "Patient 1",
      before: "/images/gdi-ba-1-before.webp",
      after: "/images/gdi-ba-1-after.webp",
    },
    {
      label: "Patient 2",
      before: "/images/gdi-ba-2-before.webp",
      after: "/images/gdi-ba-2-after.webp",
    },
    {
      label: "Patient 3",
      before: "/images/gdi-ba-3-before.webp",
      after: "/images/gdi-ba-3-after.webp",
    },
...
export const DOCTOR = {
  ...
  body: "With more than 30 years of experience, Dr Bikramjit (Dr Bik Sandhu) and the team at Sparkling White Dental Goondiwindi are known for gentle, unhurried care. We listen first, aim to answer all your questions in your free, person-to-person consultation, and only ever recommend what you actually need.",
  photo: "/images/gdi-dr-bik.webp",
  capName: "Dr Bikramjit (Dr Bik Sandhu)",
  capRole: "Principal Dentist · Goondiwindi clinic",
  statBig: "30+",
...
export const FAQS = {
  ...
  items: [
    ...
    },
    {
      ...
      a: "Leave your details below with your preferred date, and our Goondiwindi team will call you back the same day to confirm.",
    },
  ],
};
...
export const FORM = {
  ...
  sub: "Tell us a little about you and your preferred appointment time — our Goondiwindi team will call to confirm.",
