    ...
    <>
      ...
      <div className="announce">
        <div className="container">
          <span>
            <strong>New patients welcome</strong> at our Goondiwindi clinic
          </span>
        ...
        <div className="container">
          <div className="hero-anim">
            <div className="hero-badge">
              ...
              <span>
                Proudly serving <b>Goondiwindi</b> and the surrounding district
              </span>
            </div>
            <h1>
              Family Dentist <br />
              <span className="accent">Goondiwindi</span>
            </h1>
            <p className="hero-sub">
              Modern, affordable dental care for the whole family — right here in
              Goondiwindi, all in one convenient location.
            </p>
            ...
            <div className="hero-trust">
              <div>
                ...
                <div className="t-text">
                  Loved by <b>Goondiwindi families</b>
                </div>
              </div>
          ...
          <div className="hero-visual">
            <div className="hero-photo">
              <Image
                src={MEDIA.drBik}
                alt="Dr. Bik, Principal Dentist at Sparkling White Dental, Goondiwindi"
                fill
                priority
              ...
              <div className="hero-photo-cap">
                ...
                <div className="cap-role">
                  Principal Dentist · Goondiwindi clinic
                </div>
              </div>
            </div>
            <div className="hero-float tl">
              ...
              <div>
                <div className="hf-big">10+ yrs</div>
        ...
        <div className="container">
          <div className="about-visual reveal">
            <div className="about-photo">
              <Image
                src={MEDIA.team}
                alt="Dr. Bik and the team with a happy patient at Sparkling White Dental, Goondiwindi"
                fill
            ...
            <div className="about-card">
              <div className="ac-lead">
                ...
                <div className="ac-role">Principal Dentist · Goondiwindi</div>
              </div>
              <div className="ac-stats">
                ...
                <div className="ac-stat">
                  <b>10</b>
                  <span>Years in Goondiwindi</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="about-body reveal">
            ...
            <h2>Experienced Goondiwindi dentists, led by Dr. Bik</h2>
            <p>
              For the past 10 years we&rsquo;ve proudly served Goondiwindi and the
              surrounding district with modern, affordable dental care — earning a
              reputation as a trusted local family dentist along the way.
            </p>
            <blockquote className="about-quote">
              &ldquo;At Sparkling White Dental, you&rsquo;re not just a patient —
              you&rsquo;re part of our family.&rdquo;
            </blockquote>
            <ul className="about-list">
              ...
              <li>
                ...
                A highly regarded dental team, local to Goondiwindi
              </li>
            </ul>
        ...
        <div className="container">
          <div className="emergency-card reveal">
            <div>
              ...
              <h2>Emergency dentist in Goondiwindi</h2>
              <p>
      ...
      <section id="reviews" className="section reviews">
        <div className="container">
          <div className="section-head center reveal">
            ...
            <h2>Trusted by Goondiwindi families for generations</h2>
            <p>
          ...
          <p className="reviews-caption">
            ...
            <b>4.91 / 5</b> by verified patients on Doctify
          </p>
        </div>
      </section>
      ...
      <section id="contact" className="section location">
        <div className="container">
          <div className="loc-card reveal">
            ...
            <h2>Sparkling White Dental, Goondiwindi</h2>
          ...
          <div className="map-wrap reveal">
            <iframe
              title="Sparkling White Dental, Goondiwindi — map"
              src={BIZ.mapEmbed}
              loading="lazy"
      ...
      <section className="final-cta">
        <div className="container">
          ...
          <p>
            Join the Goondiwindi families who trust Sparkling White Dental. Book
      ...
      <footer className="footer">
        <div className="container">
          <div>
            ...
            <p className="f-about">
              Your family dentist in Goondiwindi — 10 years of modern, affordable
              care for the local community, led by Dr. Bik.
            </p>
          </div>
        ...
        <div className="footer-bottom">
          <div className="container">
            ...
            <div>
              Also caring for patients in West End &amp; Goondiwindi
